        ...
        <Container>
          <Row>
            <Col sm={12} md={6} className="bg-light">
              ...
              <p className="mb-3">
                CaLeader has a strong and committed sales staff with many years
              ...
              <div className="d-flex">
                ...
                <div>
                  <p>
                    <span className="fw-bold">Office Address:</span> <br />
                    <small>Block B, House 64 Rd No 18, Dhaka 1212</small>
                  </p>
                </div>
              </div>
              <div className="d-flex">
                ...
                <div>
                  <p>
                    <span className="fw-bold">Service Department Address:</span>{' '}
                    <br />
                    <small>Block B, House 64 Rd No 18, Dhaka 1212</small>
                  </p>
                </div>
              ...
              <div className="d-flex">
                ...
                <div>
                  <p>
                    <span className="fw-bold">Call Center:</span> <br />
                    <small>01731335439</small>
                  </p>
                </div>
              </div>
              <div className="d-flex">
                ...
                <div>
                  <p>
                    <span className="fw-bold">E-mail:</span> <br />
                    <small>ambroseshishir306@gmail.com</small>
                  </p>
                </div>
              </div>
              <div className="d-flex">
                ...
                <div>
                  <p>
                    <span className="fw-bold">Operating Hours</span> <br />
                    <div className="d-flex">
                      <div className="pe-4">
                        <small>
            ...
            <Col sm={12} md={6}>
              ...
              <Button variant="outline-danger" className="px-3 py-2">
                Send Message
              </Button>
            </Col>
          </Row>
