    ...
    return (
        ...
        <Container fluid className='py-5'>
            <Container className='pb-5 pt-4'>
                <Row>
                    <Col>
                        ...
                        <p>SCD MOTORS has been raising the standard of used car retailing with one of the most innovative and reliable used vehicle programmes ever created. A comprehensive range of benefits as standard has evolved over time and, today, drivers can leave the forecourt with total reassurance and peace of mind.</p>
            ...
            <Container className='py-5'>
                <h4 className='fw-bold fs-2 text-center py-4'>Reasons to Buy From <span className='text-danger'>SCD MOTORS</span></h4>
                <Row className='pt-5'>
                    <Col>
                        <div className='mb-5'>
                ...
                <Row>
                    <Col>
                        ...
                        <div>
                            ...
                            <p className='fs-6'>SCD MOTORS will be the number one DMS supplier in terms of market share, or market share growth, in every market in which we choose to compete. The success of our customers will be the ultimate measure of the uncompromising quest for excellence by all our people.</p>
                        </div>
                    </Col>
                    <Col sm={12} md={6} lg={6}>
